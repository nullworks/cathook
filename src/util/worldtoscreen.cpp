...
/*
 *
 *	This is meant to be a thing that you could plug vars into, and it would output world to screen shit.
 *	Currently, its just a bunch of copy-pasted functions from the source 2007 sdk.
 *	TODO, rewrite, make it work
 *		-Onee
 *
 */
