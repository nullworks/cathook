...
/*
 *
 *	XORstring for encrypting strings during compile time.
 *	A problem is when you want to return a string but its not after an if statement.
 *	It will fail to compile :(
 *	As requested, the credits go to "LeFF" and the credits are below.
 *		-Onee
 *
 */
