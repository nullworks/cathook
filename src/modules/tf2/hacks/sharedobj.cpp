...
#include <unistd.h>	// Null definition, Io stuff,size_t type definitions?, gethostname() and fork()
#include <link.h>	// Unknown
#include <dlfcn.h>	// dlopen, libary stuff
#include <string.h>	// Strings

#include "../../../logging.h"				// Logging
#include "../../../util/stringhelpers.hpp"	// String formating
