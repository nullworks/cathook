...
class CatVar {
public:
	CatVar(CatVar_t type, std::string name, std::string defaults, std::string desc_short, std::string desc_long = "If you're reading this then somebody forgot to add a description. whoops! Report on Discord.");
