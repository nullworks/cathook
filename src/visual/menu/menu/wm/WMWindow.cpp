...
settings::RVariable<rgba_t> color_border{ "zk.style.window.color.border", "446498ff" };
settings::RVariable<rgba_t> color_background{ "zk.style.window.color.background.active", "1d2f40" };
