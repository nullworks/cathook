...
CatCommand update_gui_color("gui_color_update", "Update the GUI Color", []() {
    hack::command_stack().push("cat set zk.style.color-preview.color.border 446498ff;cat set zk.style.checkbox.color.hover 00a098ff;cat set zk.style.input.slider.color.handle_border 446498ff;cat set zk.style.input.text.color.border.active 42BC99ff");
    hack::command_stack().push("cat set zk.style.tree-list-entry.color.lines 42BC99ff;cat set zk.style.window.color.border 446498ff");
});
